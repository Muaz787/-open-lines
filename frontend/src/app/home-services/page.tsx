...
export const metadata: Metadata = {
  title: 'AI Receptionist for Home Services (HVAC, Plumbing, Electrical) — Open Lines',
  description: 'Win the job while you’re on the tools. Open Lines answers your HVAC, plumbing or electrical calls 24/7, triages emergencies, and books the service call into your calendar. 7-day free trial — no credit card.',
